...
company_receiver.set_contact("10010001001")
...
personal_signatory.set_tenantName("个人用户")
personal_signatory.set_serialNo(2)
personal_receiver = User()
personal_receiver.set_contact("10010001002")
...
sign_user = User()
sign_user.set_contact("10010001002")
